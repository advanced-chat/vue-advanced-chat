...
pre-GA `@advanced-chat/components@3.0.0-rc.3` working tree. Unlike the
...
| -------------------------------------------- | ---------------------------------------------------------- | ------- | ------------------------------------------------------------------------------ |
| Stable `vue-advanced-chat@2.1.2`             | Pre-GA `@advanced-chat/components@3.0.0-rc.3` tree         | Done    | Separate package and release track; not an in-place upgrade.                   |
