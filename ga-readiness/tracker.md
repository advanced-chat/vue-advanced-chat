...
| `GA-016` | Open issue/PR triage is incomplete for GA                                                  | High    | RC4    | Verified    | Done             | -                | 0       | `agent-release`  | `@aerovulpe`    | -          | Reconcile on inventory change and rerun before RC4 authorization                                        | `2026-08-10T16:26:02Z` | `EV-006`, `EV-010`           |
...
| `G-009` | Candidate docs and triage ready           | RC4           | Running | `docs-triage-gate` / `npm run verify:release-docs` | Candidate wording truthful; inventory predicate below is zero                                             | `@aerovulpe`    | `G-000`, `GA-012`, `GA-016`                                                              | RC4       | `EV-010` | Docs, issue inventory, or package status change     |
