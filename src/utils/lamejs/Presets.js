...
function Presets() {
  ...
  function apply_abr_preset(gfp, preset, enforce) {
    ...
    if (abr_switch_map[r].masking_adj > 0) {
      if (enforce != 0) { gfp.maskingadjust_short = abr_switch_map[r].masking_adj * 0.9 } else if (!(Math.abs(gfp.maskingadjust_short - 0) > 0)) { gfp.maskingadjust_short = abr_switch_map[r].masking_adj * 0.9 }
